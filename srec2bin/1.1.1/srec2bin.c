...
void print_help(void)
{
	...
	printf("   -p level      (add if 'Hit RETURN to EXIT' is required prior to terminating)\n");
	printf("\n");
	printf("NOTES:\n");
	printf("\n");
	...
	printf("\n");
	printf("  2MB binary file, 'fred.rom' from f1.s19, f2.mot, and f3.s37 w/blanks = 0xFF, with a prompt output\n");
	printf("    srec2bin fred.bin -M 2 -p 1 -s f1.s19 f2.mot f3.s37\n");
	printf("\n");
